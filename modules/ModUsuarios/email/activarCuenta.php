  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #F0F0F0;width: 100%" cellpadding="0" cellspacing="0">
	...
	<div style="line-height:200%;color:#555555;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif; padding-right: 30px; padding-left: 30px; padding-top: 10px; padding-bottom: 10px;">	
        <div style="line-height:24px;font-size:12px;color:#555555;font-family:'Verdanaf', Georgia, Times, 'Times New Roman', serif;text-align:left;">
            <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: justify;"><span style="font-size: 16px; line-height: 32px;">Te damos la <strong style="font-family: Verdana; font-size: 14px; font-style: italic; font-weight: bold;">Bienvenida</strong></span></p>
            ...
            <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left"><span style="color: #3C86E9; font-size: 14px; line-height: 16px;"><?=$usuario?></span></p><p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left"></p>
            <p style="margin: 0;line-height: 24px;text-align: left;font-size: 12px" dir="ltr">&#160;<br></p>
            <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left"><span style="font-size: 16px; line-height: 32px;">Código de acceso:</span></p><p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left"></p>
            <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left"><span style="color: #3C86E9; font-size: 14px; line-height: 16px;"><?=$codigo?></span></p><p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left"></p>

            <p style="margin: 0;line-height: 24px;text-align: left;font-size: 12px" dir="ltr">&#160;<br></p>

            <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: justify;"><span style="font-size: 16px; line-height: 32px;">Para ingresar al sitio automaticamente hazlo desde el siguiente link:</span></p>
