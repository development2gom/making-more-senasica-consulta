...
/**
 * This is the model class for table "cat_status_sesiones".
 *
 ...
 */
class CatStatusSesiones extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(EntSesiones::className(), ['id_status' => 'id_status']);
    }
}
