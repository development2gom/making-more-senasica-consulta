...
!function (e, i) { "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof exports ? module.exports = i(require("jquery")) : e.Dropify = i(e.jQuery) }(this, function (e) {
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                defaultFile: "", maxFileSize: 0, minWidth: 0, maxWidth: 0, minHeight: 0, maxHeight: 0, showRemove: !0, showLoader: !0, showErrors: !0, errorTimeout: 3e3, errorsPosition: "overlay", imgFileExtensions: ["png", "jpg", "jpeg", "gif", "bmp"], maxFileSizePreview: "5M", allowedFormats: ["portrait", "square", "landscape"], allowedFileExtensions: ["*"], messages: { "default": "Arrastra y suelta el archivo aquí o da clic", replace: "Arrastra y suelta el archivo aquí o da clic", remove: "Remover", error: "Espera, algo salio mal." }, error: {
                    fileSize: "El archivo es demasiado grande: máximo ({{ value }} ).", minWidth: "La imagen es demasiado pequeña: mínimo ({{ value }}}px ).", maxWidth: "El ancho de la imagen es muy grande : máximo ({{ value }}}px).", minHeight: "El alto de la imagen es muy pequeño: mínimo ({{ value }}}px).",
                    maxHeight: "El alto de la imagen es muy grande: máximo ({{ value }}px ).",
                    imageFormat: "El formato de la imagen no esta permitido solamente ({{ value }}).",
                    fileExtension: "El archivo no esta permitido solamente ({{ value }})."
